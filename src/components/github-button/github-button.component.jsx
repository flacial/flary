...
const GitHubButton = () => {
  ...
  return (
    <Button as="a" href="https://www.github.com/flacial/flary" _focus={focusBorderColorInput} focusBorderColor={focusBorderColorInput} boxShadow="lg" target="_blank" outline="none" outlineColor="initial" style={{ outlineStyle: 'none' }} m="4" mr="-1" rounded="xl">
