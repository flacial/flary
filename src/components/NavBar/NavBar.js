...
const NavBar = () => {
    ...
    return (
      ...
      <Box display='flex' justifyContent='flex-end'>
        <Button _focus={focusBorderColorInput} focusBorderColor={focusBorderColorInput} boxShadow='lg' outline='none' outlineColor='initial' style={{outlineStyle: 'none' }} m='4' rounded='xl' onClick={toggleColorMode}>
          {colorMode === "light" 
          ?
